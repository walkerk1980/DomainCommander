...
del /Q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\AppData\Local\Temp\*

rmdir /s /Q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\AppData\Local\Temp\

mkdir \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\AppData\Local\Temp\

del /Q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\"AppData\Local\Microsoft\Windows"\"Temporary Internet Files"\*

del /q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\"AppData\Local\Microsoft\Windows"\"Temporary Internet Files"\content.ie5\*

del /q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\"AppData\Local\Microsoft\Windows"\"Temporary Internet Files"\content.MSO\*

del /q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\"AppData\Local\Microsoft\Windows"\"Temporary Internet Files"\content.Outlook\*

del /q \\%COMPUTERNAME%\C$\"Documents and Settings"\%PROFILENAME%\"AppData\Local\Microsoft\Windows"\"Temporary Internet Files"\content.word\*
